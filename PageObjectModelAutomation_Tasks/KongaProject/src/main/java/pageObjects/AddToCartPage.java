...
public class AddToCartPage {
    ...
    private final By totalItemCount = By.xpath("//div[@class='a03ba_1Zj-T']");
    private final By addItem = By.xpath("//button[@name='increment']");
    private final By checkOutButton = By.xpath("//div[@class='_2aac2_3bwnD  _841f1_1RZK9']");
