...
public class SearchPage {
    ...
    private final By AddToCartButton = By.xpath("//button[@class='_0a08a_3czMG']");
    private final By MyCartButton= By.xpath("//a[@class='_79484_1sLEt _7ad32_SD12Y _16536_xxIKG']");
